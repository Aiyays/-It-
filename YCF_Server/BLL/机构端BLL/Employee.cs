...
namespace YCF_Server.BLL
{
	...
	{
		private readonly YCF_Server.DAL.Employee dal=new YCF_Server.DAL.Employee();
		public Employee()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YCF_Server.Model.Employee GetModelByCache(int EID)
		{
			...
			return (YCF_Server.Model.Employee)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YCF_Server.Model.Employee> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YCF_Server.Model.Employee> DataTableToList(DataTable dt)
		{
			List<YCF_Server.Model.Employee> modelList = new List<YCF_Server.Model.Employee>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YCF_Server.Model.Employee model;
