...
namespace YCF_Server.BLL
{
	...
	{
		private readonly YCF_Server.DAL.SLevel dal=new YCF_Server.DAL.SLevel();
		public SLevel()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YCF_Server.Model.SLevel GetModelByCache(int LID)
		{
			
			string CacheKey = "SLevelModel-" + LID;
			...
			return (YCF_Server.Model.SLevel)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YCF_Server.Model.SLevel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YCF_Server.Model.SLevel> DataTableToList(DataTable dt)
		{
			List<YCF_Server.Model.SLevel> modelList = new List<YCF_Server.Model.SLevel>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YCF_Server.Model.SLevel model;
