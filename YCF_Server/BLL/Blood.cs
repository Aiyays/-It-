...
namespace YCF_Server.BLL
{
	...
	{
		private readonly YCF_Server.DAL.Blood dal=new YCF_Server.DAL.Blood();
		public Blood()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public YCF_Server.Model.Blood GetModelByCache(int BID)
		{
			
			string CacheKey = "BloodModel-" + BID;
			...
			return (YCF_Server.Model.Blood)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<YCF_Server.Model.Blood> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<YCF_Server.Model.Blood> DataTableToList(DataTable dt)
		{
			List<YCF_Server.Model.Blood> modelList = new List<YCF_Server.Model.Blood>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				YCF_Server.Model.Blood model;
