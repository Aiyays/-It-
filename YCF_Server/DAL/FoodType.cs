...
namespace YCF_Server.DAL
{
	...
	public partial class FoodType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("TID", "FoodType"); 
		}
		...
		public YCF_Server.Model.FoodType GetModel(int TID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TID,Type from FoodType ");
			strSql.Append(" where TID=@TID");
			SqlParameter[] parameters = {
					new SqlParameter("@TID", SqlDbType.Int,4)
			};
			...
			YCF_Server.Model.FoodType model=new YCF_Server.Model.FoodType();
		...
		/// 得到一个对象实体
		/// </summary>
		public YCF_Server.Model.FoodType DataRowToModel(DataRow row)
		{
			YCF_Server.Model.FoodType model=new YCF_Server.Model.FoodType();
			if (row != null)
			{
