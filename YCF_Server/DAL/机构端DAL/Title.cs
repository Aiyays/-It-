...
namespace YCF_Server.DAL
{
	...
	public partial class Title
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("TID", "Title"); 
		}
		...
		public YCF_Server.Model.Title GetModel(int TID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TID,Name from Title ");
			strSql.Append(" where TID=@TID");
			SqlParameter[] parameters = {
					new SqlParameter("@TID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public YCF_Server.Model.Title DataRowToModel(DataRow row)
		{
			YCF_Server.Model.Title model=new YCF_Server.Model.Title();
			if (row != null)
			{
