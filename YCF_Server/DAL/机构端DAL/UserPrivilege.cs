...
namespace YCF_Server.DAL
{
	...
	public partial class UserPrivilege
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "UserPrivilege"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from UserPrivilege");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UserPrivilege ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public YCF_Server.Model.UserPrivilege DataRowToModel(DataRow row)
		{
			YCF_Server.Model.UserPrivilege model=new YCF_Server.Model.UserPrivilege();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from UserPrivilege T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "UserPrivilege";
