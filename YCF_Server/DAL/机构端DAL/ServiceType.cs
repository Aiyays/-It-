...
namespace YCF_Server.DAL
{
	...
	public partial class ServiceType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("TID", "ServiceType"); 
		}
		...
		public YCF_Server.Model.ServiceType GetModel(int TID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TID,Type from ServiceType ");
			strSql.Append(" where TID=@TID");
			SqlParameter[] parameters = {
					new SqlParameter("@TID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public YCF_Server.Model.ServiceType DataRowToModel(DataRow row)
		{
			YCF_Server.Model.ServiceType model=new YCF_Server.Model.ServiceType();
			if (row != null)
			{
