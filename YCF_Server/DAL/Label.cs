...
namespace YCF_Server.DAL
{
	...
	public partial class Label
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("LID", "Label"); 
		}
		...
		public YCF_Server.Model.Label GetModel(int LID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 LID,Label from Label ");
			strSql.Append(" where LID=@LID");
			SqlParameter[] parameters = {
					new SqlParameter("@LID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public YCF_Server.Model.Label DataRowToModel(DataRow row)
		{
			YCF_Server.Model.Label model=new YCF_Server.Model.Label();
			if (row != null)
			{
