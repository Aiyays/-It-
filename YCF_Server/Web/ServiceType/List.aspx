<%@ Page Title="考题选项表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="YCF_Server.Web.ServiceType.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Type" HeaderText="服务类型" SortExpression="Type" ItemStyle-HorizontalAlign="Center"  /> 
