<%@ Page Title="考题选项表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="YCF_Server.Web.Role.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="RNumber" HeaderText="角色编号" SortExpression="RNumber" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="DID" HeaderText="部门ID-外键" SortExpression="DID" ItemStyle-HorizontalAlign="Center"  /> 
