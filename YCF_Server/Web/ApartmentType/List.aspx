<%@ Page Title="ApartmentType" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="YCF_Server.Web.ApartmentType.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Type" HeaderText="房间类型" SortExpression="Type" ItemStyle-HorizontalAlign="Center"  /> 
