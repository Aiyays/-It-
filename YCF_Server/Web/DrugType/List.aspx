<%@ Page Title="机构部门表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="YCF_Server.Web.DrugType.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="DrugType" HeaderText="药品类型" SortExpression="DrugType" ItemStyle-HorizontalAlign="Center"  /> 
