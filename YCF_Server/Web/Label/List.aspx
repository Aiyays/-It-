<%@ Page Title="考题表（BADL、I" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="YCF_Server.Web.Label.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="Label" HeaderText="标签" SortExpression="Label" ItemStyle-HorizontalAlign="Center"  /> 
